...
document.querySelectorAll('[data-degree]').forEach(element => element.addEventListener('change', function (event) {
  console.log(event);
  degree[event.target.dataset.index] = event.target.valueAsNumber;
}));